...
animatedtext("starting the word lister...")
...
print('''
 .----------------.  .----------------.  .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| | _____  _____ | || |     ____     | || |  _______     | || |  ________    | | | |   _____      | || |     _____    | || |    _______   | || |  _________   | || |  _________   | || |  _______     | |
| ||_   _||_   _|| || |   .'    `.   | || | |_   __ \    | || | |_   ___ `.  | | | |  |_   _|     | || |    |_   _|   | || |   /  ___  |  | || | |  _   _  |  | || | |_   ___  |  | || | |_   __ \    | |
| |  | | /\ | |  | || |  /  .--.  \  | || |   | |__) |   | || |   | |   `. \ | | | |    | |       | || |      | |     | || |  |  (__ \_|  | || | |_/ | | \_|  | || |   | |_  \_|  | || |   | |__) |   | |
| |  | |/  \| |  | || |  | |    | |  | || |   |  __ /    | || |   | |    | | | | | |    | |   _   | || |      | |     | || |   '.___`-.   | || |     | |      | || |   |  _|  _   | || |   |  __ /    | |
| |  |   /\   |  | || |  \  `--'  /  | || |  _| |  \ \_  | || |  _| |___.' / | | | |   _| |__/ |  | || |     _| |_    | || |  |`\____) |  | || |    _| |_     | || |  _| |___/ |  | || |  _| |  \ \_  | |
| |  |__/  \__|  | || |   `.____.'   | || | |____| |___| | || | |________.'  | | | |  |________|  | || |    |_____|   | || |  |_______.'  | || |   |_____|    | || | |_________|  | || | |____| |___| | |
| |              | || |              | || |              | || |              | | | |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
''')
...
animatedtext('Your Word List Is Being Generated It Might Take A While....')
